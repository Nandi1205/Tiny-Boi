...
module.exports = (interaction, channel) => {
  ...
  else if (!BOT_PERMS.has(PermissionsBitField.Flags.EmbedLinks)) return error(interaction, "I can't send embeds in this channel so I couldn't complete the action.")
  else return true
}