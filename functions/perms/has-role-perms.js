...
module.exports = (interaction, channel) => {
  ...
  else if (!BOT_PERMS.has(PermissionFlagsBits.ManageRoles)) return error(interaction, "I can't give or take away roles in this server so I couldn't complete the action.")
  else return true
}